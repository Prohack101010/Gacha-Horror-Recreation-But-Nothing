...
--Modified by Lily(mcagabe19)
HudAssets = {'healthBar','healthBarBG','iconP1','iconP2','timeBar','timeBarBG','accuracyBar','scoreBar','topBar','songName','accuracyTxt','scoreCTxt','durationTxt','missesTxt','songTxt'}
Index = 1
