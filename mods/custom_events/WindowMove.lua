...
function onEvent(name, value1, value2)
    if name == "WindowMove" then
        ...
        setPropertyFromClass('openfl.Lib', 'application.window.width', width/getRandomInt(0.001,2.999)) 
	    setPropertyFromClass('openfl.Lib', 'application.window.height', height/getRandomInt(0.001,2.999)) 
	    else
