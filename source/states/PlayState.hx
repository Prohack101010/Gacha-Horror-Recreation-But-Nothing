...
class PlayState extends MusicBeatState
{
	...
	override function closeSubState()
	{
		...
		if (paused)
		{
			...
			paused = false;
			mobileControls.visible = #if !android virtualPad.visible = #end
			true;
	...
	override public function update(elapsed:Float)
	{
		...
		if ((controls.PAUSE #if android || FlxG.android.justReleased.BACK #else || virtualPad.buttonP.justPressed #end)
		...
		if (ret != LuaUtils.Function_Stop && !transitioning)
		{
			...
			else
			{
				...
				switch (SONG.song)
				{
					...
					case 'Old Despair' | 'Old Isolation' | 'Old Red Slot' | 'Mike' | 'Luniverse' | 'Christmas Horror':
