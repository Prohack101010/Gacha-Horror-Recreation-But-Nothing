...
noteSkin1 = SONG.opponentArrowSkin;
		if(noteSkin1 == null)
			noteSkin1 = Note.defaultNoteSkin;
		noteSkin = SONG.playerArrowSkin;
		if(noteSkin == null)
		...
		switch (curStage)
		{
			case 'Gachastage' | 'stage': new states.stages.GachaStage();
			case 'Gacha Hell': new states.stages.Nothing();
		}
