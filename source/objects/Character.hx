...
class Character extends FlxSprite
{
	...
	**/
	...
	inline public function getAnimationName():String
	{
		...
		@:privateAccess
		if (!isAnimationNull())
			name = #if flxanimate !isAnimateAtlas? #end
		animation.curAnim.name #if flxanimate :atlas.anim.lastPlayedAnim #end;
	...
	public function isAnimationFinished():Bool
	{
		if (isAnimationNull())
			return false;
		return #if flxanimate !isAnimateAtlas? #end
		animation.curAnim.finished #if flxanimate :atlas.anim.finished #end;
	}
	...
	private function get_animPaused():Bool
	{
		if (isAnimationNull())
			return false;
		return #if flxanimate !isAnimateAtlas? #end
		animation.curAnim.paused #if flxanimate :atlas.anim.isPlaying #end;
	}
