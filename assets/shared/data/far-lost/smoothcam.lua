...
function onUpdate(dt)
	...
	local followXAdd = (dadShift.x * (mustHitSection and pix or pix2)) + (bfShift.x * (mustHitSection and pix2 or pix))
	local followYAdd = (dadShift.y * (mustHitSection and pix or pix2)) + (bfShift.y * (mustHitSection and pix2 or pix))
